...
export const wordManagementListApi = (data?: any): Promise<any> => {
  return axiosGet('/bms/crm-api/word/v1/page-list', data);
}
...
export const addWordApi = (data?: any): Promise<any> => {
  return axiosPost('/bms/crm-api/word/v1/insert', data);
}
...
export const updateWordApi = (data?: any): Promise<any> => {
  return axiosPost('/bms/crm-api/word/v1/update', data);
}
...
export const deleteWordApi = (data?: any): Promise<any> => {
  return axiosPost('/bms/crm-api/word/v1/delete', data);
}
...
export const publishWordApi = (data?: any): Promise<any> => {
  return axiosPost('/bms/crm-api/word/v1/publish', data);
}
...
export const importWordApi = (data?: any): Promise<any> => {
  return axiosPost('/bms/crm-api/word/v1/import', data);
}
...
export const importWordSaveApi = (data?: any): Promise<any> => {
  return axiosGet('/bms/crm-api/word/v1/import-save', data);
}
