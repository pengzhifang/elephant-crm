...
import { Form, Row, Col, Select, Input, Button, Dropdown, MenuProps, Table, Space, Modal, message, Popover, Image } from 'antd';
...
const SentenceManage: React.FC = () => {
  ...
  const columns: ColumnType<any>[] = [
    ...
    },
    {
      ...
      width: 100,
      render: (value) => {
        return value ? <Image className='w-full !h-[50px] cursor-pointer' src={value} alt='img' /> : ''
      }
    },
    {
      title: '拼音',
  ...
  return (
    <div>
        ...
        >
          <Row wrap gutter={24}>
            <Col lg={{ span: 12 }} xl={{ span: 4 }}>
              <Form.Item name="keyword" label="句子/备注">
            ...
            <Col lg={{ span: 12 }} xl={{ span: 4 }}>
              <Form.Item name="wordType" label="类型">
                <Select placeholder="请选择">
                  <Option value="">全部</Option>
            ...
            <Col lg={{ span: 12 }} xl={{ span: 4 }}>
              <Form.Item name="wordLevel" label="等级">
                <Select placeholder="请选择">
      ...
      {/* 新建/编辑字词 */}
      {detailVisible && <EditModal visible={detailVisible} editInfo={editInfo} setModalVisible={(flag) => {
      ...
      <BatchImportModal
        {...{
          ...
          templateUrl: 'https://img.bestchinese.cc/4b3c7350cd894c6b8377270dbd80dfac.zip'
        }}
